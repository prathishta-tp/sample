...
<body>
  ...
  <div class="form-group">
     &nbsp;&nbsp;&nbsp;&nbsp;  Policy ID <br />
      <asp:TextBox type="text" class="form-control col-md-10 ml-4" ID="tbPolicyID" runat="server" TextMode="Number"></asp:TextBox>  <br />
     
    &nbsp;&nbsp;&nbsp;&nbsp;   Extension Date <br />

      <asp:TextBox type="text" class="form-control col-md-10 ml-4" ID="tbExtensionDate" runat="server" TextMode="Date"></asp:TextBox> <br /> 
       <small class="form-text text-muted">*Enter Extension date= End Date+Period(check in your details)<br />
              </small>
                  
</div>

        <asp:Button type="button" class="btn btn-primary col-md-10 ml-4" ID="btnUserLogin" runat="server" Text="Renew" OnClick="btnUserLogin_Click" />
          <br />  
