<%@ Page Language="C#" AutoEventWireup="true" CodeFile="claim2.aspx.cs" Inherits="claim2" %>
...
<body>
   ...
   <div class="container" >
       ...
       <div class="form-group col-md-8" style="margin-left:50px" >
           <div class="card mr-auto" runat="server" style="margin-top:90px;margin-left:300px;">
             ...
             <h1 class="card-title" align="center"><span class="badge badge-dark">Claim</span></h1>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;        Upload Documents:
  ...
  <div class="custom-file">
      <asp:FileUpload type="file" class="custom-file-input" ID="FileUpload1" runat="server"  aria-describedby="inputfile" />
   
    <label class="custom-file-label" for="inputfile1">Choose file</label>
  </div>
</div>
      &nbsp;&nbsp;
             <asp:Button type="button" class="btn btn-success col-md-10 ml-4" ID="btnclaim1" runat="server" Text="Claim" OnClick="btnclaim1_Click" />
          <br />       
</div>          
